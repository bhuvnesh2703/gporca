...
//
//	@filename:
//		CJoinOrderDynamicProgrammingMinCard.h
//
//	@doc:
//		Dynamic programming-based join order generation
//---------------------------------------------------------------------------
#ifndef GPOPT_CJoinOrderDynamicProgrammingMinCard_H
#define GPOPT_CJoinOrderDynamicProgrammingMinCard_H
...
namespace gpopt
{
	...
	//---------------------------------------------------------------------------
	//	@class:
	//		CJoinOrderDynamicProgrammingMinCard
	//
	//	@doc:
	//		Helper class for creating join orders using dynamic programming
	//
	//---------------------------------------------------------------------------
	class CJoinOrderDynamicProgrammingMinCard : public CJoinOrder
	{
	...
	}; // class CJoinOrderDynamicProgrammingMinCard

}

#endif // !GPOPT_CJoinOrderDynamicProgrammingMinCard_H
