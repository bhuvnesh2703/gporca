...
//			
//			pdxlnResult = CTranslatorExprToDXLUtils::PdxlnResult
//													(
//													 m_pmp,
//													 Pdxlprop(pexpr),
//													 pdxlnPrLNew,
...
//			CExpression *pexprSpool = GPOS_NEW(m_pmp) CExpression
//			(
//			 m_pmp,
//			 GPOS_NEW(m_pmp) CPhysicalSpool(m_pmp),
//			 pexprOuterChild
//			 );
////
////			CExpressionHandle exprhdl(m_pmp);
////			exprhdl.Attach(pexprSpool);
////			exprhdl.DeriveProps(NULL /*pdpctxt*/);
//			CDXLPhysicalProperties *pdxlprop1 = Pdxlprop(pexprSpool);
			pdxlprop->AddRef();
