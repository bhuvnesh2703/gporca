...
//
//	@filename:
//		CJoinOrderDynamicProgrammingMinCard.cpp
//
//	@doc:
...
#include "gpopt/xforms/CJoinOrderDynamicProgrammingMinCard.h"
...
//
//---------------------------------------------------------------------------
CJoinOrderDynamicProgrammingMinCard::SComponentPair::SComponentPair
	(
	CBitSet *pbsFst,
	CBitSet *pbsSnd
	)
...
//---------------------------------------------------------------------------
//	@function:
//		CJoinOrderDynamicProgrammingMinCard::SComponentPair::HashValue
//
//	@doc:
//		Hash function
//
...
//---------------------------------------------------------------------------
//	@function:
//		CJoinOrderDynamicProgrammingMinCard::SComponentPair::Equals
//
//	@doc:
//		Equality function
//
...
//---------------------------------------------------------------------------
//	@function:
//		CJoinOrderDynamicProgrammingMinCard::CJoinOrderDynamicProgrammingMinCard
//
//	@doc:
//		Ctor
//
...
//---------------------------------------------------------------------------
//	@function:
//		CJoinOrderDynamicProgrammingMinCard::AddJoinOrder
//
//	@doc:
...
//---------------------------------------------------------------------------
//	@function:
//		CJoinOrderDynamicProgrammingMinCard::PexprLookup
//
//	@doc:
...
//---------------------------------------------------------------------------
//	@function:
//		CJoinOrderDynamicProgrammingMinCard::PexprPred
//
//	@doc:
...
//---------------------------------------------------------------------------
//	@function:
//		CJoinOrderDynamicProgrammingMinCard::DeriveStats
//
//	@doc:
...
//---------------------------------------------------------------------------
//	@function:
//		CJoinOrderDynamicProgrammingMinCard::InsertExpressionCost
//
//	@doc:
...
//---------------------------------------------------------------------------
//	@function:
//		CJoinOrderDynamicProgrammingMinCard::DCost
//
//	@doc:
	...
	)
{
	...
	return pexpr->Pstats()->Rows();
}

//---------------------------------------------------------------------------
//	@function:
//		CJoinOrderDynamicProgrammingMinCard::PexprBuildPred
//
//	@doc:
...
CExpression *
CJoinOrderDynamicProgrammingMinCard::JoinComp
(
 CBitSet *pbsFirst,
 CBitSet *pbsSecond,
...
void
CJoinOrderDynamicProgrammingMinCard::AddExprAlternativeToBitSetMap
	(
	CBitSet *pbs,
	CExpression *expr,
...
CJoinOrderDynamicProgrammingMinCard::BitSetToExpressionArrayMap *
CJoinOrderDynamicProgrammingMinCard::SearchJoinOrder
	(
...
void
CJoinOrderDynamicProgrammingMinCard::AddExprArrayAlternativesToMap
(
...
CJoinOrderDynamicProgrammingMinCard::BitSetToExpressionArrayMap *
CJoinOrderDynamicProgrammingMinCard::MergeAlternatives
	(
...
void
CJoinOrderDynamicProgrammingMinCard::AddExprFromMap
	(
...
CBitSetArray *
CJoinOrderDynamicProgrammingMinCard::GetThisLevelArray
	(
...
CJoinOrderDynamicProgrammingMinCard::BitSetToExpressionArrayMap *
CJoinOrderDynamicProgrammingMinCard::GetBushyMaps
	(
	ULONG level,
...
CExpression *
CJoinOrderDynamicProgrammingMinCard::PexprExpand()
{
...
CJoinOrderDynamicProgrammingMinCard::BitSetToExpressionMap*
CJoinOrderDynamicProgrammingMinCard::GetCheapest
	(
...
//---------------------------------------------------------------------------
//	@function:
//		CJoinOrderDynamicProgrammingMinCard::OsPrint
//
//	@doc:
