...
//
//---------------------------------------------------------------------------
#ifndef GPOS_CHashtableAccessorBase_H_
#define GPOS_CHashtableAccessorBase_H_
...
namespace gpos
{
	...
	class CHashtableAccessorBase : public CStackObject
	{

		private:

			// shorthand for buckets
			typedef struct CHashtable<T, K>::SBucket SBucket;
			...
			// no copy ctor
			CHashtableAccessorBase<T, K>
				(const CHashtableAccessorBase<T, K>&);
...
#endif // GPOS_CHashtableAccessorBase_H_
