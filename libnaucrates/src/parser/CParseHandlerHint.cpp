	...
	)
{
	...
	ULONG ulNaryDPJoinResultMaxEntries = CDXLOperatorFactory::UlValueFromAttrs(m_pphm->Pmm(), attrs, EdxltokenNaryJoinResultMaxEntries, EdxltokenHint, true, DP_RESULTS_MAX_ENTRIES);
