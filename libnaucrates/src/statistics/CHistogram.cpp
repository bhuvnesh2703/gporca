	...
	const
{
	...
	{
		*pdScaleFactor = DEqualityNDVJoinScaleFactor(DDistinct(), phistOther->DDistinct(), dRows, dRowsOther);
...
// set scale factor for an equijoin based on NDV
CDouble
CHistogram::DEqualityNDVJoinScaleFactor
(
...
const
{
	CDouble pdScaleFactor = CScaleFactorUtils::DDefaultScaleFactorJoin;
