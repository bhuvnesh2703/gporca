...
{
	"../data/dxl/minidump/JoinHeuristicModelCardinalityNonPartTblInnerJoin.mdp",
	"../data/dxl/minidump/JoinHeuristicModelGreedyNonPartTblInnerJoin.mdp",
	"../data/dxl/minidump/JoinHeuristicModelQueryNonPartTblInnerJoin.mdp"
};
